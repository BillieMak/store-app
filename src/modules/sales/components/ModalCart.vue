<template>
   ...
   modal header="Cantidad" :style="{ width: '25rem' }">
    <span class="p-text-secondary block mb-5">Ingrese Cantidad</span>
    <div class="flex align-items-center gap-3 mb-3">
        <label for="username" class="font-semibold w-6rem">Cantidad</label>
       <!-- <input  type="number" v-model="quantity" /> -->
        <InputNumberC 
        incrementButtonClass="font-size: 10px"
        v-model="quantity" inputId="minmax-buttons" 
